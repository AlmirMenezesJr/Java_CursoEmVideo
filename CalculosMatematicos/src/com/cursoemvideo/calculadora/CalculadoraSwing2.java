 ...
 * @author jr
 */
public class CalculadoraSwing2 extends javax.swing.JFrame {

    /**
     * Creates new form CalculadoraSwing2
     */
    public CalculadoraSwing2() { // construtor
        initComponents();
    ...
    private void initComponents() {
        ...
        btnCalc.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/Os-sinais-e-as-operações-aritméticas2.gif"))); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/calculator_icon.jpg"))); // NOI18N
        ...
        lblRC.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
    ...
    private void btnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcActionPerformed
        ...
        lblRQ.setText(String.format("%.2f",q));
        
        // raiz cubuca
        double cub = Math.cbrt(num);
        lblRC.setText(String.format("%.2f",cub));
        
       // absoluto
       int a = Math.abs(num);
       lblAbsoluto.setText(Integer.toString(a));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalculadoraSwing2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalculadoraSwing2().setVisible(true);
            }
        });
    }
